  ...
  <head>
	...
	<script type="text/javascript" charset="UTF-8">
		function open2(a,b){
			...
			diag.Height = 120;
			diag.Title = "更改角色";
			diag.URL = "/RBAC/RoleServlet?choose=role_view&user_id="+a+"&role_id="+b;
			diag.show();
	}
	</script>
  </head>
			...
			<div class="row">
				...
				<div class="span9">
					<table class="table table-bordered table-striped">
						...
						<tbody>
						<!-- 数据显示 -->
						<c:forEach var="Vo4Role" items="${roleList}" >
							<tr>
								<td>
									${Vo4Role['true_name']}
								</td>
								...
								<td>
									<input type="button" id="b" class="view-link" value="点击更改" onclick="open2('${Vo4Role['user_id']}','${Vo4Role['role_id']}')">
								</td>
							</tr>
						</c:forEach>
						</tbody>
					...
					<div class="pagination">
						<ul>
							<li >
								<a href="${pageContext.request.contextPath}/RoleServlet?pages=${currentPages-1}&choose=role_index">&laquo;</a>
							</li>
							...
							<li>
								<a href="${pageContext.request.contextPath}/RoleServlet?pages=${n}&choose=role_index">${n}</a>
							</li>
							</c:forEach>
							<li>
								<a href="${pageContext.request.contextPath}/RoleServlet?pages=${currentPages+1}&choose=role_index">&raquo;</a>
							</li>
						</ul>
					</div>
				</div>
