...
<html>
 ...
 <body>
	 <div id="forlogin">
	 <form action="/RBAC/FunctionServlet?choose=function_update&function_id=${function_id}"  method="post" >
	      <table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" bordercolor="#666666">
	      	<tr>
	      		<td colspan="2" bgcolor="#eeeeee">当前功能ID：<span id="deptnn">${function_id}</span></td>
	      	</tr>
	      	<tr>
	      		<td width="150" align="right">功能名称：</td><td><input  type="text" name="function_name" value="${function_name}" /></td>
	      	</tr>
	      	<tr>
	      		<td width="150" align="right">功能访问地址：</td><td><input  type="text" name="function_url" value="${function_url}" /></td>
	      	</tr>
	      	<tr>
	      		<td width="150" align="right">上一级功能ID：</td><td><input  type="text" name="parent_id" value="${parent_id}" /></td>
	      	</tr>
	        <tr>
		        <td width="150" align="right">功能栏级别：</td>
	         	<td>
	         	<select name="function_level">
  						<option value ="0">顶栏</option>
  						<option value ="1">子栏</option>
				</select> 
				</td>
	        </tr>
	        <tr>
